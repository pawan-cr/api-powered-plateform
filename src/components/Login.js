            ...
            <div className="card mb-0">
              <div className="card-body">
                <a href="./index.html" className="text-nowrap logo-img text-center d-block py-3 w-100">
                  ...
                  <h1 style={{fontSize:"25px"}}>LANGUAGE LEARNING</h1>
                  <p>Sign in</p>
                </a>
                ...
                <form>
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    <p className="fs-4 mb-0 fw-bold">move to signup?</p>
                    <p className="text-primary fw-bold ms-2" style={{marginTop:"20px",cursor:"pointer"}} onClick={()=>handleNavigate('/register')}>Create an account</p>
                  </div>
                </form>
              </div>
            </div>
